...
#define ATSTAR(pla, tas, sta)                                                  \
  (task[pla][tas].headed == sta && task[pla][tas].arriving <= general.time)
#define HEADEDSTAR(pla, tas, sta)                                              \
  (task[pla][tas].headed == sta && task[pla][tas].arriving > general.time)
#define INTASK(pla, tas, shi)                                                  \
  (task[pla][tas].ship_free[shi] + task[pla][tas].ship_load[shi])
#define MCOST 15
#define ICOST 15
#define RCOST 10
#define MAXSPEED 10
...
#define WHITEPEN 2
#define OTHERPEN 3
#define PLAYERPEN(n) (4 + n)
#define SPRITEPEN(n) (16 + n)
